...
namespace System.Management
{
	...
	{
		// Token: 0x0600036C RID: 876 RVA: 0x0000E031 File Offset: 0x0000D031
		...
		// Token: 0x0600036D RID: 877 RVA: 0x0000E054 File Offset: 0x0000D054
		...
		// (get) Token: 0x0600036E RID: 878 RVA: 0x0000E0BE File Offset: 0x0000D0BE
		public string Name
		{
			get
			{
		...
		// (get) Token: 0x0600036F RID: 879 RVA: 0x0000E0D4 File Offset: 0x0000D0D4
		// (set) Token: 0x06000370 RID: 880 RVA: 0x0000E10C File Offset: 0x0000D10C
		public object Value
		{
			get
			{
				this.RefreshPropertyInfo();
				return ValueTypeSafety.GetSafeObject(PropertyData.MapWmiValueToValue(this.propertyValue, (CimType)(this.propertyType & -8193), 0 != (this.propertyType & 8192)));
			}
			set
			{
				this.RefreshPropertyInfo();
				object obj = PropertyData.MapValueToWmiValue(value, (CimType)(this.propertyType & -8193), 0 != (this.propertyType & 8192));
		...
		// (get) Token: 0x06000371 RID: 881 RVA: 0x0000E1CD File Offset: 0x0000D1CD
		public CimType Type
		{
			get
			{
		...
		// (get) Token: 0x06000372 RID: 882 RVA: 0x0000E1E1 File Offset: 0x0000D1E1
		public bool IsLocal
		{
			get
			{
		...
		// (get) Token: 0x06000373 RID: 883 RVA: 0x0000E1F7 File Offset: 0x0000D1F7
		public bool IsArray
		{
			get
			{
		...
		// (get) Token: 0x06000374 RID: 884 RVA: 0x0000E214 File Offset: 0x0000D214
		public string Origin
		{
			get
			{
				string text = null;
				int propertyOrigin_ = this.parent.wbemObject.GetPropertyOrigin_(this.propertyName, out text);
		...
		// (get) Token: 0x06000375 RID: 885 RVA: 0x0000E27A File Offset: 0x0000D27A
		...
		// (get) Token: 0x06000376 RID: 886 RVA: 0x0000E2A2 File Offset: 0x0000D2A2
		// (set) Token: 0x06000377 RID: 887 RVA: 0x0000E2AA File Offset: 0x0000D2AA
		...
		// Token: 0x06000378 RID: 888 RVA: 0x0000E2B4 File Offset: 0x0000D2B4
		...
		// Token: 0x06000379 RID: 889 RVA: 0x0000E5C0 File Offset: 0x0000D5C0
		...
		// Token: 0x0600037A RID: 890 RVA: 0x0000ED7C File Offset: 0x0000DD7C
