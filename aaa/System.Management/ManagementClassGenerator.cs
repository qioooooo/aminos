...
namespace System.Management
{
	...
	{
		// Token: 0x060003D8 RID: 984 RVA: 0x00010E78 File Offset: 0x0000FE78
		public ManagementClassGenerator()
		{
		}

		// Token: 0x060003D9 RID: 985 RVA: 0x00010F8C File Offset: 0x0000FF8C
		public ManagementClassGenerator(ManagementClass cls)
		{
			this.classobj = cls;
		}

		// Token: 0x060003DA RID: 986 RVA: 0x000110A4 File Offset: 0x000100A4
		public CodeTypeDeclaration GenerateCode(bool includeSystemProperties, bool systemPropertyClass)
		{
			...
			if (systemPropertyClass)
			{
				...
				codeTypeDeclaration = this.GenerateSystemPropertiesClass();
			}
			else
			{
				this.CheckIfClassIsProperlyInitialized();
				this.InitializeCodeGeneration();
				codeTypeDeclaration = this.GetCodeTypeDeclarationForClass(includeSystemProperties);
			}
			return codeTypeDeclaration;
		}

		// Token: 0x060003DB RID: 987 RVA: 0x000110D8 File Offset: 0x000100D8
		...
		// Token: 0x060003DC RID: 988 RVA: 0x00011144 File Offset: 0x00010144
		...
		// Token: 0x060003DD RID: 989 RVA: 0x000111B3 File Offset: 0x000101B3
		...
		// Token: 0x060003DE RID: 990 RVA: 0x000111D0 File Offset: 0x000101D0
		...
		// Token: 0x060003DF RID: 991 RVA: 0x000116D8 File Offset: 0x000106D8
		...
		// Token: 0x060003E0 RID: 992 RVA: 0x00011774 File Offset: 0x00010774
			...
			else
			{
				...
				if (array.Length >= 2 && array[0] == '\\' && array[1] == '\\')
				{
					...
					for (int i = 2; i < length; i++)
					{
						if (flag)
						{
							this.OriginalNamespace += array[i];
						}
						else if (array[i] == '\\')
						{
							flag = true;
		...
		// Token: 0x060003E1 RID: 993 RVA: 0x00011920 File Offset: 0x00010920
		...
		// Token: 0x060003E2 RID: 994 RVA: 0x00011E58 File Offset: 0x00010E58
		private void ProcessNamingCollisions()
		{
			...
			string text5 = this.PrivateNamesUsed["GeneratedClassName"].ToString() + "Collection";
			this.PrivateNamesUsed.Add("CollectionClass", this.ResolveCollision(text5, true));
			text5 = this.PrivateNamesUsed["GeneratedClassName"].ToString() + "Enumerator";
			this.PrivateNamesUsed.Add("EnumeratorClass", this.ResolveCollision(text5, true));
		}

		// Token: 0x060003E3 RID: 995 RVA: 0x000121B4 File Offset: 0x000111B4
		...
		// Token: 0x060003E4 RID: 996 RVA: 0x000122D4 File Offset: 0x000112D4
		...
		// Token: 0x060003E5 RID: 997 RVA: 0x00012448 File Offset: 0x00011448
		...
		// Token: 0x060003E6 RID: 998 RVA: 0x00012518 File Offset: 0x00011518
		...
		// Token: 0x060003E7 RID: 999 RVA: 0x000126CC File Offset: 0x000116CC
		...
		// Token: 0x060003E8 RID: 1000 RVA: 0x00012898 File Offset: 0x00011898
		...
		// Token: 0x060003E9 RID: 1001 RVA: 0x00012C74 File Offset: 0x00011C74
		...
		// Token: 0x060003EA RID: 1002 RVA: 0x0001306C File Offset: 0x0001206C
		private void GenerateProperties()
		{
			...
			for (int i = 0; i < this.PublicProperties.Count; i++)
			{
				...
				if (propertyData.Type == CimType.DateTime)
				{
					...
					flag2 = this.GetDateTimeType(propertyData, ref type);
					this.cmp.Type = type;
				}
				...
				bool flag6 = false;
				string text2 = this.ProcessPropertyQualifiers(propertyData, ref flag3, ref flag4, ref flag5, flag, out flag6);
				if (flag3 || flag4)
				{
					if (text2.Length != 0)
					{
					...
					bool flag7 = this.GeneratePropertyHelperEnums(propertyData, this.PublicProperties[propertyData.Name].ToString(), flag6);
					if (flag3)
					{
						if (ManagementClassGenerator.IsPropertyValueType(propertyData.Type) && !propertyData.IsArray)
						{
							...
							if (propertyData.Type != CimType.DateTime)
							{
								...
								else
								{
									...
									if (propertyData.IsArray)
									{
										CodeExpression[] array = new CodeExpression[] { this.cmie };
										this.cis.TrueStatements.Add(new CodeMethodReturnStatement(new CodeArrayCreateExpression(this.cmp.Type, array)));
									}
									else
									{
					...
					if (flag4)
					{
						...
						CodeBinaryOperatorExpression codeBinaryOperatorExpression = new CodeBinaryOperatorExpression(new CodeVariableReferenceExpression(this.PrivateNamesUsed["IsEmbedded"].ToString()), CodeBinaryOperatorType.ValueEquality, new CodePrimitiveExpression(false));
		...
		// Token: 0x060003EB RID: 1003 RVA: 0x00013DF8 File Offset: 0x00012DF8
		private string ProcessPropertyQualifiers(PropertyData prop, ref bool bRead, ref bool bWrite, ref bool bStatic, bool bDynamicClass, out bool nullable)
		{
			...
			foreach (QualifierData qualifierData in prop.Qualifiers)
			{
				...
				{
					text = qualifierData.Value.ToString();
				}
							...
							try
							{
								...
								if (ManagementClassGenerator.isTypeInt(prop.Type) && qualifierData.Value != null)
								{
									...
									for (int j = 0; j < array2.Length; j++)
									{
										...
										string text2 = ManagementClassGenerator.ConvertValuesToName(array2[j]);
										arrayList.Add(text2);
									}
							...
							try
							{
								...
								if (ManagementClassGenerator.isTypeInt(prop.Type) && qualifierData.Value != null)
								{
									...
									for (int l = 0; l < array4.Length; l++)
									{
										...
										string text3 = ManagementClassGenerator.ConvertValuesToName(array4[l]);
		...
		// Token: 0x060003EC RID: 1004 RVA: 0x00014334 File Offset: 0x00013334
			...
			if (this.Values.Count > 0 && (this.ValueMap.Count == 0 || this.ValueMap.Count == this.Values.Count))
			{
				...
				for (int i = 0; i < this.Values.Count; i++)
				{
					...
					if (this.ValueMap.Count > 0)
					{
						...
						long num2 = global::System.Convert.ToInt64(this.ValueMap[i], (IFormatProvider)CultureInfo.InvariantCulture.GetFormat(typeof(ulong)));
						if (num2 > num)
						{
							num = num2;
						}
						if (!flag2 && global::System.Convert.ToInt64(this.ValueMap[i], (IFormatProvider)CultureInfo.InvariantCulture.GetFormat(typeof(ulong))) == 0L)
						{
							flag2 = true;
						}
					}
			...
			if (this.BitValues.Count > 0 && (this.BitMap.Count == 0 || this.BitMap.Count == this.BitValues.Count))
			{
				...
				for (int j = 0; j < this.BitValues.Count; j++)
				{
					...
					if (this.BitMap.Count > 0)
					{
						...
						long num5 = global::System.Convert.ToInt64(this.BitMap[j], (IFormatProvider)CultureInfo.InvariantCulture.GetFormat(typeof(ulong)));
						if (num5 > num4)
						{
							num4 = num5;
						}
					...
					if (!flag2 && global::System.Convert.ToInt64(this.BitMap[j], (IFormatProvider)CultureInfo.InvariantCulture.GetFormat(typeof(ulong))) == 0L)
					{
						flag2 = true;
					}
					this.EnumObj.Members.Add(this.cmf);
		...
		// Token: 0x060003ED RID: 1005 RVA: 0x0001496C File Offset: 0x0001396C
		private void GenerateConstructPath()
		{
			...
			else
			{
				...
				{
					CodeMethodInvokeExpression codeMethodInvokeExpression4;
					if (((CodeTypeReference)this.arrKeyType[j]).BaseType == "System.String")
					{
						CodeMethodInvokeExpression codeMethodInvokeExpression = ManagementClassGenerator.GenerateConcatStrings(new CodeVariableReferenceExpression("key" + this.arrKeys[j]), new CodePrimitiveExpression("\""));
						CodeMethodInvokeExpression codeMethodInvokeExpression2 = ManagementClassGenerator.GenerateConcatStrings(new CodePrimitiveExpression("\""), codeMethodInvokeExpression);
						CodeMethodInvokeExpression codeMethodInvokeExpression3 = ManagementClassGenerator.GenerateConcatStrings(new CodePrimitiveExpression((j == 0) ? ("." + this.arrKeys[j] + "=") : ("," + this.arrKeys[j] + "=")), codeMethodInvokeExpression2);
						codeMethodInvokeExpression4 = ManagementClassGenerator.GenerateConcatStrings(new CodeVariableReferenceExpression(text2), codeMethodInvokeExpression3);
					}
					else
					{
						this.cmie = new CodeMethodInvokeExpression();
						...
						CodeMethodInvokeExpression codeMethodInvokeExpression5 = ManagementClassGenerator.GenerateConcatStrings(new CodePrimitiveExpression((j == 0) ? ("." + this.arrKeys[j] + "=") : ("," + this.arrKeys[j] + "=")), this.cmie);
						codeMethodInvokeExpression4 = ManagementClassGenerator.GenerateConcatStrings(new CodeVariableReferenceExpression(text2), codeMethodInvokeExpression5);
					}
					this.cmm.Statements.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text2), codeMethodInvokeExpression4));
				}
		...
		// Token: 0x060003EE RID: 1006 RVA: 0x00014CAC File Offset: 0x00013CAC
		...
		// Token: 0x060003EF RID: 1007 RVA: 0x00014E50 File Offset: 0x00013E50
		...
		// Token: 0x060003F0 RID: 1008 RVA: 0x00015150 File Offset: 0x00014150
		...
		// Token: 0x060003F1 RID: 1009 RVA: 0x000154C8 File Offset: 0x000144C8
		...
		// Token: 0x060003F2 RID: 1010 RVA: 0x000155E4 File Offset: 0x000145E4
		...
		// Token: 0x060003F3 RID: 1011 RVA: 0x00015714 File Offset: 0x00014714
		...
		// Token: 0x060003F4 RID: 1012 RVA: 0x00015868 File Offset: 0x00014868
		...
		// Token: 0x060003F5 RID: 1013 RVA: 0x00015A24 File Offset: 0x00014A24
		...
		// Token: 0x060003F6 RID: 1014 RVA: 0x00015BC0 File Offset: 0x00014BC0
		...
		// Token: 0x060003F7 RID: 1015 RVA: 0x00015DB4 File Offset: 0x00014DB4
		...
		// Token: 0x060003F8 RID: 1016 RVA: 0x00015F40 File Offset: 0x00014F40
		private void GenarateConstructorWithLateBound()
		{
			string text = "theObject";
			string text2 = "SystemProperties";
			this.cctor = new CodeConstructor();
			this.cctor.Attributes = MemberAttributes.Public;
			this.cpde = new CodeParameterDeclarationExpression();
			...
			this.cis = new CodeConditionStatement();
			this.cpre = new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text), text2);
		...
		// Token: 0x060003F9 RID: 1017 RVA: 0x00016270 File Offset: 0x00015270
		...
		// Token: 0x060003FA RID: 1018 RVA: 0x00016570 File Offset: 0x00015570
		...
		// Token: 0x060003FB RID: 1019 RVA: 0x00016A4C File Offset: 0x00015A4C
		private void GenerateMethods()
		{
			...
			for (int i = 0; i < this.PublicMethods.Count; i++)
			{
				...
				string text4 = this.PrivateNamesUsed["LateBoundObject"].ToString();
				...
				if (flag)
				{
					...
					this.cis.TrueStatements.Add(new CodeVariableDeclarationStatement(new CodeTypeReference(this.PublicNamesUsed["PathClass"].ToString()), text5, codeObjectCreateExpression));
					...
					codeObjectCreateExpression2.Parameters.Add(new CodeVariableReferenceExpression(text5));
				...
				if (methodData.InParameters != null && methodData.InParameters.Properties != null)
				{
					foreach (PropertyData propertyData2 in methodData.InParameters.Properties)
					{
						...
						if (flag4)
						{
							this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text4), "GetMethodParameters", new CodeExpression[]
							{
						...
						if (propertyData2.Type == CimType.DateTime)
						{
							...
							flag5 = this.GetDateTimeType(propertyData2, ref type);
							this.cpde.Type = type;
						}
				...
				if (methodData.OutParameters != null && methodData.OutParameters.Properties != null)
				{
					foreach (PropertyData propertyData3 in methodData.OutParameters.Properties)
					{
						...
						if (flag4)
						{
							this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text4), "InvokeMethod", new CodeExpression[0]);
						...
						if (!flag8)
						{
							if (string.Compare(propertyData3.Name, "ReturnValue", StringComparison.OrdinalIgnoreCase) == 0)
							{
								...
								if (propertyData3.Type == CimType.DateTime)
								{
									...
									this.GetDateTimeType(propertyData3, ref returnType);
									this.cmm.ReturnType = returnType;
								}
								codeTypeReference = this.cmm.ReturnType;
								flag3 = propertyData3.IsArray;
							}
							else
							{
								this.cpde = new CodeParameterDeclarationExpression();
								...
								if (propertyData3.Type == CimType.DateTime)
								{
									...
									flag5 = this.GetDateTimeType(propertyData3, ref type2);
				...
				if (flag6)
				{
					CodeVariableDeclarationStatement codeVariableDeclarationStatement = new CodeVariableDeclarationStatement(codeTypeReference, "retVar");
					this.cpre = new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "Properties");
					this.cie = new CodeIndexerExpression(this.cpre, new CodeExpression[]
					{
					...
					if (codeTypeReference.BaseType == new CodeTypeReference(this.PublicNamesUsed["PathClass"].ToString()).BaseType)
					{
						...
						this.GenerateCodeForRefAndDateTimeTypes(this.cie, flag3, this.cis.TrueStatements, this.PublicNamesUsed["PathClass"].ToString(), new CodeVariableReferenceExpression("retVar"), true);
					...
					else if (codeTypeReference.BaseType == "System.DateTime")
					{
						...
						this.GenerateCodeForRefAndDateTimeTypes(this.cie, flag3, this.cis.TrueStatements, "System.DateTime", new CodeVariableReferenceExpression("retVar"), true);
						this.cis.TrueStatements.Add(new CodeMethodReturnStatement(new CodeVariableReferenceExpression("retVar")));
					...
					else if (codeTypeReference.BaseType == "System.TimeSpan")
					{
						...
						this.GenerateCodeForRefAndDateTimeTypes(this.cie, flag3, this.cis.TrueStatements, "System.TimeSpan", new CodeVariableReferenceExpression("retVar"), true);
						this.cis.TrueStatements.Add(new CodeMethodReturnStatement(new CodeVariableReferenceExpression("retVar")));
						this.cis.FalseStatements.Add(new CodeMethodReturnStatement(new CodeVariableReferenceExpression("retVar")));
					}
		...
		// Token: 0x060003FC RID: 1020 RVA: 0x00017FCC File Offset: 0x00016FCC
		...
		// Token: 0x060003FD RID: 1021 RVA: 0x00018104 File Offset: 0x00017104
		...
		// Token: 0x060003FE RID: 1022 RVA: 0x00018234 File Offset: 0x00017234
		...
		// Token: 0x060003FF RID: 1023 RVA: 0x00018364 File Offset: 0x00017364
		...
		// Token: 0x06000400 RID: 1024 RVA: 0x000184B4 File Offset: 0x000174B4
		...
		// Token: 0x06000401 RID: 1025 RVA: 0x00018B1C File Offset: 0x00017B1C
		...
		// Token: 0x06000402 RID: 1026 RVA: 0x00018CA8 File Offset: 0x00017CA8
		...
		// Token: 0x06000403 RID: 1027 RVA: 0x00018E2C File Offset: 0x00017E2C
		...
		// Token: 0x06000404 RID: 1028 RVA: 0x00019394 File Offset: 0x00018394
		...
		// Token: 0x06000405 RID: 1029 RVA: 0x000193A4 File Offset: 0x000183A4
		...
		// Token: 0x06000406 RID: 1030 RVA: 0x00019454 File Offset: 0x00018454
		private CodeTypeDeclaration GenerateTypeConverterClass()
		{
			string text = "System.ComponentModel.ITypeDescriptorContext";
			string text2 = "context";
			string text3 = "destinationType";
			string text4 = "value";
			string text5 = "System.Globalization.CultureInfo";
			string text6 = "culture";
			string text7 = "System.Collections.IDictionary";
			string text8 = "dictionary";
			string text9 = "PropertyDescriptorCollection";
			string text10 = "attributeVar";
			string text11 = "inBaseType";
			string text12 = "baseConverter";
			string text13 = "baseType";
			string text14 = "TypeDescriptor";
			string text15 = "srcType";
			...
			this.cctor.Attributes = MemberAttributes.Public;
			this.cpde = new CodeParameterDeclarationExpression();
			this.cpde.Name = text11;
			this.cpde.Type = new CodeTypeReference("System.Type");
			this.cctor.Parameters.Add(this.cpde);
			this.cmie = new CodeMethodInvokeExpression(new CodeTypeReferenceExpression(text14), "GetConverter", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text11));
			this.cctor.Statements.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text12), this.cmie));
			this.cctor.Statements.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text13), new CodeVariableReferenceExpression(text11)));
			codeTypeDeclaration.Members.Add(this.cctor);
			this.cmm = new CodeMemberMethod();
			this.cmm.Attributes = (MemberAttributes)24836;
			this.cmm.Name = "CanConvertFrom";
			this.cmm.ReturnType = new CodeTypeReference("System.Boolean");
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression(text, text2));
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression("System.Type", text15));
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text12), "CanConvertFrom", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text2));
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text15));
			this.cmm.Statements.Add(new CodeMethodReturnStatement(this.cmie));
			...
			this.cmm.ReturnType = new CodeTypeReference("System.Boolean");
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression(text, text2));
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression("System.Type", text3));
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text12), "CanConvertTo", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text2));
			...
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression(text, text2));
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression(text5, text6));
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression(new CodeTypeReference("System.Object"), text4));
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text12), "ConvertFrom", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text2));
			...
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression(text, text2));
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression(text7, text8));
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text12), "CreateInstance", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text2));
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text8));
			this.cmm.Statements.Add(new CodeMethodReturnStatement(this.cmie));
			codeTypeDeclaration.Members.Add(this.cmm);
			this.cmm = new CodeMemberMethod();
			this.cmm.Attributes = (MemberAttributes)24836;
			...
			this.cmm.ReturnType = new CodeTypeReference("System.Boolean");
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression(text, text2));
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text12), "GetCreateInstanceSupported", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text2));
			this.cmm.Statements.Add(new CodeMethodReturnStatement(this.cmie));
			codeTypeDeclaration.Members.Add(this.cmm);
			this.cmm = new CodeMemberMethod();
			...
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression(codeTypeReference, text10));
			this.cmm.ReturnType = new CodeTypeReference(text9);
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text12), "GetProperties", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text2));
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text4));
			...
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression(text, text2));
			this.cmm.ReturnType = new CodeTypeReference("System.Boolean");
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text12), "GetPropertiesSupported", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text2));
			this.cmm.Statements.Add(new CodeMethodReturnStatement(this.cmie));
			codeTypeDeclaration.Members.Add(this.cmm);
			this.cmm = new CodeMemberMethod();
			...
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text12), "GetStandardValues", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text2));
			this.cmm.Statements.Add(new CodeMethodReturnStatement(this.cmie));
			codeTypeDeclaration.Members.Add(this.cmm);
			this.cmm = new CodeMemberMethod();
			...
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression(text, text2));
			this.cmm.ReturnType = new CodeTypeReference("System.Boolean");
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text12), "GetStandardValuesExclusive", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text2));
			this.cmm.Statements.Add(new CodeMethodReturnStatement(this.cmie));
			codeTypeDeclaration.Members.Add(this.cmm);
			this.cmm = new CodeMemberMethod();
			...
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression(text, text2));
			this.cmm.ReturnType = new CodeTypeReference("System.Boolean");
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text12), "GetStandardValuesSupported", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text2));
			this.cmm.Statements.Add(new CodeMethodReturnStatement(this.cmie));
			codeTypeDeclaration.Members.Add(this.cmm);
			this.cmm = new CodeMemberMethod();
			...
			this.cmm.Parameters.Add(new CodeParameterDeclarationExpression("System.Type", text3));
			this.cmm.ReturnType = new CodeTypeReference("System.Object");
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text12), "ConvertTo", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text2));
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text6));
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text4));
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text3));
			...
			codeBinaryOperatorExpression.Left = new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text13), "BaseType");
			...
			CodeBinaryOperatorExpression codeBinaryOperatorExpression3 = new CodeBinaryOperatorExpression(new CodeVariableReferenceExpression("value"), CodeBinaryOperatorType.ValueEquality, new CodePrimitiveExpression(null));
			CodeBinaryOperatorExpression codeBinaryOperatorExpression4 = new CodeBinaryOperatorExpression(new CodeVariableReferenceExpression(text2), CodeBinaryOperatorType.IdentityInequality, new CodePrimitiveExpression(null));
			...
			this.cmie = new CodeMethodInvokeExpression(new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "PropertyDescriptor"), "ShouldSerializeValue", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "Instance"));
			CodeBinaryOperatorExpression codeBinaryOperatorExpression6 = new CodeBinaryOperatorExpression(this.cmie, CodeBinaryOperatorType.ValueEquality, new CodePrimitiveExpression(false));
			CodeBinaryOperatorExpression codeBinaryOperatorExpression7 = new CodeBinaryOperatorExpression();
			codeBinaryOperatorExpression7.Left = codeBinaryOperatorExpression5;
			codeBinaryOperatorExpression7.Right = codeBinaryOperatorExpression6;
			codeBinaryOperatorExpression7.Operator = CodeBinaryOperatorType.BooleanAnd;
			this.cis.TrueStatements.Add(new CodeConditionStatement(codeBinaryOperatorExpression7, new CodeStatement[]
			{
			...
			codeBinaryOperatorExpression.Left = new CodeVariableReferenceExpression(text13);
			...
			codeBinaryOperatorExpression2.Left = new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text13), "BaseType");
			...
			codeBinaryOperatorExpression3 = new CodeBinaryOperatorExpression(new CodeVariableReferenceExpression("value"), CodeBinaryOperatorType.ValueEquality, new CodePrimitiveExpression(null));
			codeBinaryOperatorExpression4 = new CodeBinaryOperatorExpression(new CodeVariableReferenceExpression(text2), CodeBinaryOperatorType.IdentityInequality, new CodePrimitiveExpression(null));
			...
			this.cmie = new CodeMethodInvokeExpression(new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "PropertyDescriptor"), "ShouldSerializeValue", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "Instance"));
			codeBinaryOperatorExpression6 = new CodeBinaryOperatorExpression(this.cmie, CodeBinaryOperatorType.ValueEquality, new CodePrimitiveExpression(false));
			codeBinaryOperatorExpression7 = new CodeBinaryOperatorExpression();
			codeBinaryOperatorExpression7.Left = codeBinaryOperatorExpression5;
			codeBinaryOperatorExpression7.Right = codeBinaryOperatorExpression6;
			codeBinaryOperatorExpression7.Operator = CodeBinaryOperatorType.BooleanAnd;
			this.cis.TrueStatements.Add(new CodeConditionStatement(codeBinaryOperatorExpression7, new CodeStatement[]
			...
			this.cmm.Statements.Add(this.cis);
			this.cis = new CodeConditionStatement();
			codeBinaryOperatorExpression = new CodeBinaryOperatorExpression(new CodeVariableReferenceExpression(text2), CodeBinaryOperatorType.IdentityInequality, new CodePrimitiveExpression(null));
			this.cmie = new CodeMethodInvokeExpression(new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "PropertyDescriptor"), "ShouldSerializeValue", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "Instance"));
		...
		// Token: 0x06000407 RID: 1031 RVA: 0x0001A5C4 File Offset: 0x000195C4
		private void GenerateCollectionClass()
		{
			string text = "ManagementObjectCollection";
			string text2 = "privColObj";
			string text3 = "objCollection";
			...
			this.cf.Name = text2;
			this.cf.Attributes = (MemberAttributes)20482;
			this.cf.Type = new CodeTypeReference(text);
			this.ccc.Members.Add(this.cf);
			this.cctor = new CodeConstructor();
			this.cctor.Attributes = MemberAttributes.Public;
			this.cpde = new CodeParameterDeclarationExpression();
			this.cpde.Name = text3;
			this.cpde.Type = new CodeTypeReference(text);
			this.cctor.Parameters.Add(this.cpde);
			this.cctor.Statements.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text2), new CodeVariableReferenceExpression(text3)));
			...
			this.cmp.GetStatements.Add(new CodeMethodReturnStatement(new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "Count")));
			...
			this.cmp.ImplementationTypes.Add("System.Collections.ICollection");
			this.cmp.GetStatements.Add(new CodeMethodReturnStatement(new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "IsSynchronized")));
			this.ccc.Members.Add(this.cmp);
			this.cmp = new CodeMemberProperty();
			...
			this.cmm.Parameters.Add(this.cpde);
			this.cpde = new CodeParameterDeclarationExpression();
			this.cpde.Name = text5;
			this.cpde.Type = new CodeTypeReference("System.Int32");
			this.cmm.Parameters.Add(this.cpde);
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text2), "CopyTo", new CodeExpression[0]);
			this.cmie.Parameters.Add(new CodeVariableReferenceExpression(text4));
			...
			this.cmm.Statements.Add(new CodeVariableDeclarationStatement("System.Int32", text6));
			this.cfls = new CodeIterationStatement();
			this.cfls.InitStatement = new CodeAssignStatement(new CodeVariableReferenceExpression(text6), new CodePrimitiveExpression(0));
			this.cboe = new CodeBinaryOperatorExpression();
			this.cboe.Left = new CodeVariableReferenceExpression(text6);
			this.cboe.Operator = CodeBinaryOperatorType.LessThan;
			this.cboe.Right = new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text4), "Length");
			this.cfls.TestExpression = this.cboe;
			this.cfls.IncrementStatement = new CodeAssignStatement(new CodeVariableReferenceExpression(text6), new CodeBinaryOperatorExpression(new CodeVariableReferenceExpression(text6), CodeBinaryOperatorType.Add, new CodePrimitiveExpression(1)));
			this.cmie = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text4), "SetValue", new CodeExpression[0]);
			CodeMethodInvokeExpression codeMethodInvokeExpression = new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text4), "GetValue", new CodeExpression[]
			{
				new CodeVariableReferenceExpression(text6)
			});
			this.coce = new CodeObjectCreateExpression();
			...
			this.coce.Parameters.Add(new CodeMethodInvokeExpression(new CodeVariableReferenceExpression(text2), "GetEnumerator", new CodeExpression[0]));
			this.cmm.Statements.Add(new CodeMethodReturnStatement(this.coce));
			this.ccc.Members.Add(this.cmm);
		...
		// Token: 0x06000408 RID: 1032 RVA: 0x0001AD14 File Offset: 0x00019D14
		private void GenerateEnumeratorClass()
		{
			...
			this.cf.Name = text;
			this.cf.Attributes = (MemberAttributes)20482;
			this.cf.Type = new CodeTypeReference(text3 + "." + text2);
			this.ecc.Members.Add(this.cf);
			this.cctor = new CodeConstructor();
			this.cctor.Attributes = MemberAttributes.Public;
			this.cpde = new CodeParameterDeclarationExpression();
			this.cpde.Name = text4;
			this.cpde.Type = new CodeTypeReference(text3 + "." + text2);
			this.cctor.Parameters.Add(this.cpde);
			this.cctor.Statements.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text), new CodeVariableReferenceExpression(text4)));
		...
		// Token: 0x06000409 RID: 1033 RVA: 0x0001B0CC File Offset: 0x0001A0CC
		...
		// Token: 0x0600040A RID: 1034 RVA: 0x0001B108 File Offset: 0x0001A108
		...
		// Token: 0x0600040B RID: 1035 RVA: 0x0001B280 File Offset: 0x0001A280
		...
		// (get) Token: 0x0600040C RID: 1036 RVA: 0x0001B305 File Offset: 0x0001A305
		...
		// (get) Token: 0x0600040D RID: 1037 RVA: 0x0001B30D File Offset: 0x0001A30D
		...
		// Token: 0x0600040E RID: 1038 RVA: 0x0001B344 File Offset: 0x0001A344
		...
		// Token: 0x0600040F RID: 1039 RVA: 0x0001B3E4 File Offset: 0x0001A3E4
		private void ResolveEnumNameValues(ArrayList arrIn, ref ArrayList arrayOut)
		{
			...
			for (int i = 0; i < arrIn.Count; i++)
			{
				...
				{
					int num = 0;
					text = arrIn[i].ToString() + num.ToString(formatProvider);
		...
		// Token: 0x06000410 RID: 1040 RVA: 0x0001B49C File Offset: 0x0001A49C
		...
		// Token: 0x06000411 RID: 1041 RVA: 0x0001B4D4 File Offset: 0x0001A4D4
		private bool InitializeCodeGenerator(CodeLanguage lang)
		{
			...
			try
			{
				...
				case CodeLanguage.VJSharp:
				{
					...
					Assembly assembly = Assembly.Load(assemblyName2);
					if (assembly != null)
					{
				...
				case CodeLanguage.Mcpp:
				{
					...
					assemblyName2.Version = new Version(this.VSVERSION);
					Assembly assembly = Assembly.Load(assemblyName2);
					if (assembly != null)
					{
			...
			{
				throw new ArgumentOutOfRangeException(string.Format(ManagementClassGenerator.GetString("UNABLE_TOCREATE_GEN_EXCEPT"), text));
			}
			if (flag)
			{
		...
		// Token: 0x06000412 RID: 1042 RVA: 0x0001B6C4 File Offset: 0x0001A6C4
		...
		// Token: 0x06000413 RID: 1043 RVA: 0x0001B6F0 File Offset: 0x0001A6F0
		...
		// Token: 0x06000414 RID: 1044 RVA: 0x0001BAEC File Offset: 0x0001AAEC
		private static int ConvertBitMapValueToInt32(string bitMap)
		{
			...
			if (bitMap.StartsWith(text, StringComparison.Ordinal) || bitMap.StartsWith(text.ToUpper(CultureInfo.InvariantCulture), StringComparison.Ordinal))
			{
				...
				num = global::System.Convert.ToInt32(text, (IFormatProvider)CultureInfo.InvariantCulture.GetFormat(typeof(int)));
			}
			else
			{
				num = global::System.Convert.ToInt32(bitMap, (IFormatProvider)CultureInfo.InvariantCulture.GetFormat(typeof(int)));
			}
			return num;
		}

		// Token: 0x06000415 RID: 1045 RVA: 0x0001BB98 File Offset: 0x0001AB98
		...
		// Token: 0x06000416 RID: 1046 RVA: 0x0001BCAF File Offset: 0x0001ACAF
		...
		// Token: 0x06000417 RID: 1047 RVA: 0x0001BCC4 File Offset: 0x0001ACC4
		...
		// Token: 0x06000418 RID: 1048 RVA: 0x0001BCE8 File Offset: 0x0001ACE8
		private bool IsDynamicClass()
		{
			bool flag = false;
			try
			{
				flag = global::System.Convert.ToBoolean(this.classobj.Qualifiers["dynamic"].Value, (IFormatProvider)CultureInfo.InvariantCulture.GetFormat(typeof(bool)));
			}
			catch (ManagementException)
			{
			}
		...
		// Token: 0x06000419 RID: 1049 RVA: 0x0001BD48 File Offset: 0x0001AD48
		private static string ConvertToNumericValueAndAddToArray(CimType cimType, string numericValue, ArrayList arrayToAdd, out string enumType)
		{
			...
			default:
				...
				case CimType.UInt16:
					break;
				case CimType.UInt32:
					arrayToAdd.Add(global::System.Convert.ToInt32(numericValue, (IFormatProvider)CultureInfo.InvariantCulture.GetFormat(typeof(int))));
					text = "ToInt32";
		...
		// Token: 0x0600041A RID: 1050 RVA: 0x0001BE04 File Offset: 0x0001AE04
		...
		// Token: 0x0600041B RID: 1051 RVA: 0x0001BE7D File Offset: 0x0001AE7D
		private static string GetString(string strToGet)
		{
			return RC.GetString(strToGet);
		}

		// Token: 0x0600041C RID: 1052 RVA: 0x0001BE88 File Offset: 0x0001AE88
		...
		// Token: 0x0600041D RID: 1053 RVA: 0x0001C260 File Offset: 0x0001B260
		private void GenerateIfClassvalidFuncWithAllParams()
		{
			...
			this.cmie = new CodeMethodInvokeExpression(new CodeTypeReferenceExpression("System.String"), "Compare", array);
			this.cboe = new CodeBinaryOperatorExpression();
			this.cboe.Left = this.cmie;
			...
			this.cis.FalseStatements.Add(new CodeMethodReturnStatement(new CodeMethodInvokeExpression(codeMethodReferenceExpression, new CodeExpression[] { this.coce })));
			this.cmm.Statements.Add(this.cis);
			this.cc.Members.Add(this.cmm);
		}

		// Token: 0x0600041E RID: 1054 RVA: 0x0001C5C0 File Offset: 0x0001B5C0
		private void GenerateIfClassvalidFunction()
		{
			...
			this.cis.Condition = codeBinaryOperatorExpression2;
			this.cis.TrueStatements.Add(new CodeMethodReturnStatement(new CodePrimitiveExpression(true)));
			CodeExpression codeExpression = new CodeCastExpression(new CodeTypeReference("System.Array"), new CodeIndexerExpression(new CodeVariableReferenceExpression(text), new CodeExpression[]
			{
				new CodePrimitiveExpression("__DERIVATION")
			}));
			this.cis.FalseStatements.Add(new CodeVariableDeclarationStatement("System.Array", text3, codeExpression));
			CodeConditionStatement codeConditionStatement = new CodeConditionStatement();
			this.cboe = new CodeBinaryOperatorExpression();
			...
			codeMethodInvokeExpression.Parameters.Add(new CodeVariableReferenceExpression(text2));
			CodeExpression[] array2 = new CodeExpression[]
			{
			...
			CodeMethodInvokeExpression codeMethodInvokeExpression2 = new CodeMethodInvokeExpression(new CodeTypeReferenceExpression("System.String"), "Compare", array2);
			CodeConditionStatement codeConditionStatement2 = new CodeConditionStatement();
			this.cboe = new CodeBinaryOperatorExpression();
			this.cboe.Left = codeMethodInvokeExpression2;
			this.cboe.Right = new CodePrimitiveExpression(0);
			this.cboe.Operator = CodeBinaryOperatorType.ValueEquality;
		...
		// Token: 0x0600041F RID: 1055 RVA: 0x0001CAF8 File Offset: 0x0001BAF8
		private void GenerateCodeForRefAndDateTimeTypes(CodeIndexerExpression prop, bool bArray, CodeStatementCollection statColl, string strType, CodeVariableReferenceExpression varToAssign, bool bIsValueProprequired)
		{
			if (!bArray)
			{
				...
				else
				{
					...
					{
						codeExpression = new CodeCastExpression(new CodeTypeReference("System.String"), new CodePropertyReferenceExpression(prop, "Value"));
					}
					else
					{
						codeExpression = new CodeCastExpression(new CodeTypeReference("System.String"), prop);
					}
					if (varToAssign == null)
					{
						codeConditionStatement.TrueStatements.Add(new CodeMethodReturnStatement(this.CreateObjectForProperty(strType, codeExpression)));
						codeConditionStatement.FalseStatements.Add(new CodeMethodReturnStatement(this.CreateObjectForProperty(strType, null)));
						return;
					}
					codeConditionStatement.TrueStatements.Add(new CodeAssignStatement(varToAssign, this.CreateObjectForProperty(strType, codeExpression)));
			...
			else
			{
				...
				codeConditionStatement2.TrueStatements.Add(new CodeVariableDeclarationStatement(codeTypeReference, text3, new CodeArrayCreateExpression(new CodeTypeReference(strType), new CodeVariableReferenceExpression(text))));
				this.cfls = new CodeIterationStatement();
		...
		// Token: 0x06000420 RID: 1056 RVA: 0x0001CF98 File Offset: 0x0001BF98
		private void AddPropertySet(CodeIndexerExpression prop, bool bArray, CodeStatementCollection statColl, string strType, CodeVariableReferenceExpression varValue)
		{
			...
			codeConditionStatement.TrueStatements.Add(new CodeVariableDeclarationStatement(new CodeTypeReference("System.Int32"), text, codePropertyReferenceExpression));
			CodeTypeReference codeTypeReference = new CodeTypeReference(new CodeTypeReference("System.String"), 1);
			codeConditionStatement.TrueStatements.Add(new CodeVariableDeclarationStatement(codeTypeReference, text3, new CodeArrayCreateExpression(new CodeTypeReference("System.String"), new CodeVariableReferenceExpression(text))));
			this.cfls = new CodeIterationStatement();
			this.cfls.InitStatement = new CodeVariableDeclarationStatement(new CodeTypeReference("System.Int32"), text2, new CodePrimitiveExpression(0));
			CodeBinaryOperatorExpression codeBinaryOperatorExpression = new CodeBinaryOperatorExpression();
			codeBinaryOperatorExpression.Left = new CodeVariableReferenceExpression(text2);
		...
		// Token: 0x06000421 RID: 1057 RVA: 0x0001D1F4 File Offset: 0x0001C1F4
		...
		// Token: 0x06000422 RID: 1058 RVA: 0x0001D3E8 File Offset: 0x0001C3E8
		...
		// Token: 0x06000423 RID: 1059 RVA: 0x0001D4F0 File Offset: 0x0001C4F0
		...
		// Token: 0x06000424 RID: 1060 RVA: 0x0001D820 File Offset: 0x0001C820
		...
		// Token: 0x06000425 RID: 1061 RVA: 0x0001DA48 File Offset: 0x0001CA48
		...
		// Token: 0x06000426 RID: 1062 RVA: 0x0001DF38 File Offset: 0x0001CF38
		...
		// Token: 0x06000427 RID: 1063 RVA: 0x0001E040 File Offset: 0x0001D040
		...
		// Token: 0x06000428 RID: 1064 RVA: 0x0001E444 File Offset: 0x0001D444
		...
		// Token: 0x06000429 RID: 1065 RVA: 0x0001E56A File Offset: 0x0001D56A
		...
		// Token: 0x0600042A RID: 1066 RVA: 0x0001E578 File Offset: 0x0001D578
		...
		// Token: 0x0600042B RID: 1067 RVA: 0x0001E588 File Offset: 0x0001D588
		private void AddToDateTimeFunction()
		{
			...
			codeMemberMethod.Statements.Add(new CodeVariableDeclarationStatement(new CodeTypeReference("System.Int32"), text2, new CodePropertyReferenceExpression(codeVariableReferenceExpression, "Year")));
			codeMemberMethod.Statements.Add(new CodeVariableDeclarationStatement(new CodeTypeReference("System.Int32"), text3, new CodePropertyReferenceExpression(codeVariableReferenceExpression, "Month")));
			codeMemberMethod.Statements.Add(new CodeVariableDeclarationStatement(new CodeTypeReference("System.Int32"), text4, new CodePropertyReferenceExpression(codeVariableReferenceExpression, "Day")));
			codeMemberMethod.Statements.Add(new CodeVariableDeclarationStatement(new CodeTypeReference("System.Int32"), text5, new CodePropertyReferenceExpression(codeVariableReferenceExpression, "Hour")));
			codeMemberMethod.Statements.Add(new CodeVariableDeclarationStatement(new CodeTypeReference("System.Int32"), text6, new CodePropertyReferenceExpression(codeVariableReferenceExpression, "Minute")));
			codeMemberMethod.Statements.Add(new CodeVariableDeclarationStatement(new CodeTypeReference("System.Int32"), text7, new CodePropertyReferenceExpression(codeVariableReferenceExpression, "Second")));
			...
			codeMemberMethod.Statements.Add(new CodeVariableDeclarationStatement(new CodeTypeReference("System.DateTime"), text11, codeFieldReferenceExpression));
			...
			CodeMethodReferenceExpression codeMethodReferenceExpression = new CodeMethodReferenceExpression(new CodeVariableReferenceExpression(text9), "Substring");
			CodeMethodInvokeExpression codeMethodInvokeExpression = new CodeMethodInvokeExpression();
			...
			codeConditionStatement = new CodeConditionStatement();
			codeConditionStatement.Condition = codeBinaryOperatorExpression;
			CodeMethodReferenceExpression codeMethodReferenceExpression2 = new CodeMethodReferenceExpression(new CodeTypeReferenceExpression("System.Int64"), "Parse");
			CodeMethodInvokeExpression codeMethodInvokeExpression2 = new CodeMethodInvokeExpression();
			...
			CodeMethodReferenceExpression codeMethodReferenceExpression3 = new CodeMethodReferenceExpression(new CodeVariableReferenceExpression(text11), "AddTicks");
			CodeMethodInvokeExpression codeMethodInvokeExpression3 = new CodeMethodInvokeExpression();
			codeMethodInvokeExpression3.Method = codeMethodReferenceExpression3;
			...
			codeMethodReferenceExpression2 = new CodeMethodReferenceExpression(new CodePropertyReferenceExpression(new CodeTypeReferenceExpression("System.TimeZone"), "CurrentTimeZone"), "GetUtcOffset");
			...
			codeMethodReferenceExpression = new CodeMethodReferenceExpression(new CodeVariableReferenceExpression(text9), "Substring");
			...
			codeMethodReferenceExpression = new CodeMethodReferenceExpression(new CodeVariableReferenceExpression(text11), "AddMinutes");
			codeMethodInvokeExpression = new CodeMethodInvokeExpression();
			codeMethodInvokeExpression.Method = codeMethodReferenceExpression;
		...
		// Token: 0x0600042C RID: 1068 RVA: 0x0001F3C8 File Offset: 0x0001E3C8
		...
		// Token: 0x0600042D RID: 1069 RVA: 0x0001F4C0 File Offset: 0x0001E4C0
		private void AddToDMTFTimeIntervalFunction()
		{
			...
			CodePropertyReferenceExpression codePropertyReferenceExpression = new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "Days");
			this.cmie = new CodeMethodInvokeExpression();
			...
			codeConditionStatement.TrueStatements.Add(new CodeThrowExceptionStatement(codeObjectCreateExpression));
			codeMemberMethod.Statements.Add(codeConditionStatement);
			CodeFieldReferenceExpression codeFieldReferenceExpression2 = new CodeFieldReferenceExpression(new CodeTypeReferenceExpression("System.TimeSpan"), "MinValue");
			codeMemberMethod.Statements.Add(new CodeVariableDeclarationStatement(new CodeTypeReference("System.TimeSpan"), "minTimeSpan", codeFieldReferenceExpression2));
			CodeBinaryOperatorExpression codeBinaryOperatorExpression2 = new CodeBinaryOperatorExpression();
			...
			codePropertyReferenceExpression = new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "Hours");
			this.cmie = new CodeMethodInvokeExpression();
			this.cmie.Method = new CodeMethodReferenceExpression(new CodeCastExpression(new CodeTypeReference("System.Int32 "), codePropertyReferenceExpression), "ToString");
			codeMethodInvokeExpression = new CodeMethodInvokeExpression();
			codeMethodInvokeExpression.Method = new CodeMethodReferenceExpression(this.cmie, "PadLeft");
			...
			codeMethodInvokeExpression.Parameters.Add(new CodePrimitiveExpression('0'));
			CodeMethodInvokeExpression codeMethodInvokeExpression2 = ManagementClassGenerator.GenerateConcatStrings(new CodeVariableReferenceExpression(text), codeMethodInvokeExpression);
			codeMemberMethod.Statements.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text), codeMethodInvokeExpression2));
			codePropertyReferenceExpression = new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "Minutes");
			this.cmie = new CodeMethodInvokeExpression();
			this.cmie.Method = new CodeMethodReferenceExpression(new CodeCastExpression(new CodeTypeReference("System.Int32 "), codePropertyReferenceExpression), "ToString");
			codeMethodInvokeExpression = new CodeMethodInvokeExpression();
			codeMethodInvokeExpression.Method = new CodeMethodReferenceExpression(this.cmie, "PadLeft");
			codeMethodInvokeExpression.Parameters.Add(new CodePrimitiveExpression(2));
			codeMethodInvokeExpression.Parameters.Add(new CodePrimitiveExpression('0'));
			codeMethodInvokeExpression2 = ManagementClassGenerator.GenerateConcatStrings(new CodeVariableReferenceExpression(text), codeMethodInvokeExpression);
			codeMemberMethod.Statements.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text), codeMethodInvokeExpression2));
			codePropertyReferenceExpression = new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), "Seconds");
			this.cmie = new CodeMethodInvokeExpression();
			this.cmie.Method = new CodeMethodReferenceExpression(new CodeCastExpression(new CodeTypeReference("System.Int32 "), codePropertyReferenceExpression), "ToString");
			codeMethodInvokeExpression = new CodeMethodInvokeExpression();
			codeMethodInvokeExpression.Method = new CodeMethodReferenceExpression(this.cmie, "PadLeft");
			...
			codeMethodInvokeExpression2 = ManagementClassGenerator.GenerateConcatStrings(new CodeVariableReferenceExpression(text), codeMethodInvokeExpression);
			codeMemberMethod.Statements.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text), codeMethodInvokeExpression2));
			codeMethodInvokeExpression2 = ManagementClassGenerator.GenerateConcatStrings(new CodeVariableReferenceExpression(text), new CodePrimitiveExpression("."));
			codeMemberMethod.Statements.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text), codeMethodInvokeExpression2));
			this.coce = new CodeObjectCreateExpression();
			this.coce.CreateType = new CodeTypeReference("System.TimeSpan");
			...
			this.cmie.Parameters.Add(new CodePrimitiveExpression(6));
			this.cmie.Parameters.Add(new CodePrimitiveExpression('0'));
			codeMethodInvokeExpression2 = ManagementClassGenerator.GenerateConcatStrings(new CodeVariableReferenceExpression(text), this.cmie);
			codeMemberMethod.Statements.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text), codeMethodInvokeExpression2));
			codeMethodInvokeExpression2 = ManagementClassGenerator.GenerateConcatStrings(new CodeVariableReferenceExpression(text), new CodePrimitiveExpression(":000"));
			codeMemberMethod.Statements.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text), codeMethodInvokeExpression2));
			codeMemberMethod.Statements.Add(new CodeMethodReturnStatement(new CodeVariableReferenceExpression(text)));
			this.cc.Members.Add(codeMemberMethod);
		}

		// Token: 0x0600042E RID: 1070 RVA: 0x0001FDBC File Offset: 0x0001EDBC
		private void AddToDMTFDateTimeFunction()
		{
			...
			CodeConditionStatement codeConditionStatement = new CodeConditionStatement();
			codeConditionStatement.Condition = this.cboe;
			codeMethodReferenceExpression = new CodeMethodReferenceExpression(new CodeVariableReferenceExpression(text2), "ToUniversalTime");
			codeMethodInvokeExpression = new CodeMethodInvokeExpression();
			codeMethodInvokeExpression.Method = codeMethodReferenceExpression;
		...
		// Token: 0x0600042F RID: 1071 RVA: 0x00020800 File Offset: 0x0001F800
		private void ToDMTFDateHelper(string dateTimeMember, CodeMemberMethod cmmdt, string strType)
		{
			string text = "dmtfDateTime";
			string text2 = "date";
			CodeMethodInvokeExpression codeMethodInvokeExpression = new CodeMethodInvokeExpression();
			codeMethodInvokeExpression.Method = new CodeMethodReferenceExpression(new CodeCastExpression(new CodeTypeReference(strType), new CodePropertyReferenceExpression(new CodeVariableReferenceExpression(text2), dateTimeMember)), "ToString");
			CodeMethodInvokeExpression codeMethodInvokeExpression2 = new CodeMethodInvokeExpression();
			codeMethodInvokeExpression2.Method = new CodeMethodReferenceExpression(codeMethodInvokeExpression, "PadLeft");
			codeMethodInvokeExpression2.Parameters.Add(new CodePrimitiveExpression(2));
			codeMethodInvokeExpression2.Parameters.Add(new CodePrimitiveExpression('0'));
			ManagementClassGenerator.GenerateConcatStrings(codeMethodInvokeExpression, codeMethodInvokeExpression2);
			cmmdt.Statements.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text), ManagementClassGenerator.GenerateConcatStrings(new CodeVariableReferenceExpression(text), codeMethodInvokeExpression2)));
		}

		// Token: 0x06000430 RID: 1072 RVA: 0x000208B8 File Offset: 0x0001F8B8
		...
		// Token: 0x06000431 RID: 1073 RVA: 0x00021174 File Offset: 0x00020174
		private static void ToTimeSpanHelper(int start, int numOfCharacters, string strVarToAssign, CodeStatementCollection statCol)
		{
			...
			string text2 = "dmtfTimespan";
			CodeMethodInvokeExpression codeMethodInvokeExpression = new CodeMethodInvokeExpression();
			codeMethodInvokeExpression.Method = new CodeMethodReferenceExpression(new CodeVariableReferenceExpression(text2), "Substring");
			...
			statCol.Add(new CodeAssignStatement(new CodeVariableReferenceExpression(text), codeMethodInvokeExpression));
			codeMethodInvokeExpression = new CodeMethodInvokeExpression();
		...
		// Token: 0x06000432 RID: 1074 RVA: 0x00021230 File Offset: 0x00020230
		...
		// Token: 0x06000433 RID: 1075 RVA: 0x00021270 File Offset: 0x00020270
		...
		// Token: 0x06000434 RID: 1076 RVA: 0x00021328 File Offset: 0x00020328
		private static CodeMethodInvokeExpression GenerateConcatStrings(CodeExpression ce1, CodeExpression ce2)
		{
			CodeExpression[] array = new CodeExpression[] { ce1, ce2 };
			return new CodeMethodInvokeExpression(new CodeTypeReferenceExpression("System.String"), "Concat", array);
		}
