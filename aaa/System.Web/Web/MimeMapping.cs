...
namespace System.Web
{
	...
	{
		// Token: 0x0600086F RID: 2159 RVA: 0x0002528D File Offset: 0x0002428D
		private MimeMapping()
		{
		}

		// Token: 0x06000870 RID: 2160 RVA: 0x00025295 File Offset: 0x00024295
		private static void AddMimeMapping(string extension, string MimeType)
		{
			MimeMapping._extensionToMimeMappingTable.Add(extension, MimeType);
		}

		// Token: 0x06000871 RID: 2161 RVA: 0x000252A4 File Offset: 0x000242A4
		internal static string GetMimeMapping(string FileName)
		{
			...
			{
				text = (string)MimeMapping._extensionToMimeMappingTable[FileName.Substring(num)];
			}
			if (text == null)
			{
				text = (string)MimeMapping._extensionToMimeMappingTable[".*"];
			}
			return text;
		}

		// Token: 0x06000872 RID: 2162 RVA: 0x000252FC File Offset: 0x000242FC
		static MimeMapping()
		{
