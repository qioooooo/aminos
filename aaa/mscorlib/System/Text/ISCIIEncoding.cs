...
namespace System.Text
{
	...
	{
		// Token: 0x06002A38 RID: 10808 RVA: 0x00084674 File Offset: 0x00083674
		...
		// Token: 0x06002A39 RID: 10809 RVA: 0x000846CE File Offset: 0x000836CE
		...
		// Token: 0x06002A3A RID: 10810 RVA: 0x000846E6 File Offset: 0x000836E6
		...
		// Token: 0x06002A3B RID: 10811 RVA: 0x0008470C File Offset: 0x0008370C
		...
		// Token: 0x06002A3C RID: 10812 RVA: 0x0008477C File Offset: 0x0008377C
		...
		// Token: 0x06002A3D RID: 10813 RVA: 0x000847E5 File Offset: 0x000837E5
		...
		// Token: 0x06002A3E RID: 10814 RVA: 0x000847F4 File Offset: 0x000837F4
		...
		// Token: 0x06002A3F RID: 10815 RVA: 0x000849ED File Offset: 0x000839ED
		internal unsafe override int GetCharCount(byte* bytes, int count, DecoderNLS baseDecoder)
		{
			return this.GetChars(bytes, count, null, 0, baseDecoder);
		}

		// Token: 0x06002A40 RID: 10816 RVA: 0x000849FC File Offset: 0x000839FC
			...
			while (encodingCharBuffer.MoreData)
			{
				...
				if (flag4)
				{
					...
					if (flag)
					{
						...
						{
							encodingCharBuffer.Fallback(239);
							flag2 = false;
							flag = false;
							flag3 = false;
							c = '\0';
					...
					else if (flag3)
					{
						...
						{
							flag3 = false;
							encodingCharBuffer.Fallback(240);
						}
					}
					else if (nextByte == 233)
					{
		...
		// Token: 0x06002A41 RID: 10817 RVA: 0x00084DDD File Offset: 0x00083DDD
		public override Decoder GetDecoder()
		{
			return new ISCIIEncoding.ISCIIDecoder(this);
		}

		// Token: 0x06002A42 RID: 10818 RVA: 0x00084DE5 File Offset: 0x00083DE5
		public override Encoder GetEncoder()
		{
			return new ISCIIEncoding.ISCIIEncoder(this);
		}

		// Token: 0x06002A43 RID: 10819 RVA: 0x00084DED File Offset: 0x00083DED
		...
		{
			// Token: 0x06002A45 RID: 10821 RVA: 0x00086DF8 File Offset: 0x00085DF8
			...
			// Token: 0x06002A46 RID: 10822 RVA: 0x00086E27 File Offset: 0x00085E27
			...
			// (get) Token: 0x06002A47 RID: 10823 RVA: 0x00086E4A File Offset: 0x00085E4A
		...
		{
			// Token: 0x06002A48 RID: 10824 RVA: 0x00086E67 File Offset: 0x00085E67
			...
			// Token: 0x06002A49 RID: 10825 RVA: 0x00086E82 File Offset: 0x00085E82
			public override void Reset()
			{
				this.bLastATR = false;
				this.bLastVirama = false;
			...
			// (get) Token: 0x06002A4A RID: 10826 RVA: 0x00086EBA File Offset: 0x00085EBA
			internal override bool HasState
			{
				get
				{
