...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x06005071 RID: 20593 RVA: 0x00120BC0 File Offset: 0x0011FBC0
		...
		// Token: 0x06005072 RID: 20594 RVA: 0x00120C1A File Offset: 0x0011FC1A
		...
		// Token: 0x06005073 RID: 20595 RVA: 0x00120C4A File Offset: 0x0011FC4A
		protected override void HashCore(byte[] rgb, int ibStart, int cbSize)
		{
			this._HashData(rgb, ibStart, cbSize);
		}

		// Token: 0x06005074 RID: 20596 RVA: 0x00120C55 File Offset: 0x0011FC55
		protected override byte[] HashFinal()
		{
			return this._EndHash();
		}

		// Token: 0x06005075 RID: 20597 RVA: 0x00120C60 File Offset: 0x0011FC60
		...
		// Token: 0x06005076 RID: 20598 RVA: 0x00120D00 File Offset: 0x0011FD00
		...
		// Token: 0x06005077 RID: 20599 RVA: 0x00120E2C File Offset: 0x0011FE2C
		...
		// Token: 0x06005078 RID: 20600 RVA: 0x00120F20 File Offset: 0x0011FF20
		...
		// Token: 0x06005079 RID: 20601 RVA: 0x00121233 File Offset: 0x00120233
		private static ulong RotateRight(ulong x, int n)
		{
			return (x >> n) | (x << 64 - n);
		}

		// Token: 0x0600507A RID: 20602 RVA: 0x00121245 File Offset: 0x00120245
		private static ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ ((x ^ ulong.MaxValue) & z);
		}

		// Token: 0x0600507B RID: 20603 RVA: 0x00121251 File Offset: 0x00120251
		private static ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x0600507C RID: 20604 RVA: 0x0012125E File Offset: 0x0012025E
		private static ulong Sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 28) ^ SHA384Managed.RotateRight(x, 34) ^ SHA384Managed.RotateRight(x, 39);
		}

		// Token: 0x0600507D RID: 20605 RVA: 0x0012127A File Offset: 0x0012027A
		private static ulong Sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 14) ^ SHA384Managed.RotateRight(x, 18) ^ SHA384Managed.RotateRight(x, 41);
		}

		// Token: 0x0600507E RID: 20606 RVA: 0x00121296 File Offset: 0x00120296
		private static ulong sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 1) ^ SHA384Managed.RotateRight(x, 8) ^ (x >> 7);
		}

		// Token: 0x0600507F RID: 20607 RVA: 0x001212AB File Offset: 0x001202AB
		private static ulong sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 19) ^ SHA384Managed.RotateRight(x, 61) ^ (x >> 6);
		}

		// Token: 0x06005080 RID: 20608 RVA: 0x001212C4 File Offset: 0x001202C4
