...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x06005025 RID: 20517 RVA: 0x00119B7B File Offset: 0x00118B7B
		private RijndaelManagedTransform()
		{
		}

		// Token: 0x06005026 RID: 20518 RVA: 0x00119B84 File Offset: 0x00118B84
		...
		// Token: 0x06005027 RID: 20519 RVA: 0x00119F0C File Offset: 0x00118F0C
		...
		// Token: 0x06005028 RID: 20520 RVA: 0x00119F1B File Offset: 0x00118F1B
		public void Clear()
		{
			((IDisposable)this).Dispose();
		}

		// Token: 0x06005029 RID: 20521 RVA: 0x00119F24 File Offset: 0x00118F24
		...
		// (get) Token: 0x0600502A RID: 20522 RVA: 0x0011A009 File Offset: 0x00119009
		...
		// (get) Token: 0x0600502B RID: 20523 RVA: 0x0011A011 File Offset: 0x00119011
		...
		// (get) Token: 0x0600502C RID: 20524 RVA: 0x0011A019 File Offset: 0x00119019
		...
		// (get) Token: 0x0600502D RID: 20525 RVA: 0x0011A021 File Offset: 0x00119021
		...
		// (get) Token: 0x0600502E RID: 20526 RVA: 0x0011A024 File Offset: 0x00119024
		...
		// Token: 0x0600502F RID: 20527 RVA: 0x0011A028 File Offset: 0x00119028
		...
		// Token: 0x06005030 RID: 20528 RVA: 0x0011A1A0 File Offset: 0x001191A0
		...
		// Token: 0x06005031 RID: 20529 RVA: 0x0011A2C4 File Offset: 0x001192C4
		public void Reset()
		{
			this.m_depadBuffer = null;
			if (this.m_cipherMode == CipherMode.CBC)
		...
		// Token: 0x06005032 RID: 20530 RVA: 0x0011A320 File Offset: 0x00119320
		...
		// Token: 0x06005033 RID: 20531 RVA: 0x0011A9A0 File Offset: 0x001199A0
									...
									fixed (int* ptr3 = RijndaelManagedTransform.s_iT)
									{
										fixed (int* ptr4 = RijndaelManagedTransform.s_iTF)
										{
											...
											else
											{
												...
												case PaddingMode.PKCS7:
												{
													int num18 = (int)outputBuffer[inputCount - 1];
													if (num18 > outputBuffer.Length || num18 > this.InputBlockSize || num18 <= 0)
													{
														throw new CryptographicException(Environment.GetResourceString("Cryptography_PKCS7_InvalidPadding"));
													}
													for (int j = 1; j <= num18; j++)
													{
														if ((int)outputBuffer[inputCount - j] != num18)
														{
															throw new CryptographicException(Environment.GetResourceString("Cryptography_PKCS7_InvalidPadding"));
														}
													}
													array = new byte[outputBuffer.Length - num18];
													Buffer.InternalBlockCopy(outputBuffer, 0, array, 0, outputBuffer.Length - num18);
													break;
												}
												case PaddingMode.ANSIX923:
												{
		...
		// Token: 0x06005034 RID: 20532 RVA: 0x0011B050 File Offset: 0x0011A050
		...
		// Token: 0x06005035 RID: 20533 RVA: 0x0011B244 File Offset: 0x0011A244
		...
		// Token: 0x06005036 RID: 20534 RVA: 0x0011B464 File Offset: 0x0011A464
		...
		// Token: 0x06005037 RID: 20535 RVA: 0x0011B73B File Offset: 0x0011A73B
		private static int rot1(int val)
		{
			return ((val << 8) & -256) | ((val >> 24) & 255);
		}

		// Token: 0x06005038 RID: 20536 RVA: 0x0011B751 File Offset: 0x0011A751
		private static int rot2(int val)
		{
			return ((val << 16) & -65536) | ((val >> 16) & 65535);
		}

		// Token: 0x06005039 RID: 20537 RVA: 0x0011B768 File Offset: 0x0011A768
		private static int rot3(int val)
		{
			return ((val << 24) & -16777216) | ((val >> 8) & 16777215);
		}

		// Token: 0x0600503A RID: 20538 RVA: 0x0011B780 File Offset: 0x0011A780
		...
		// Token: 0x0600503B RID: 20539 RVA: 0x0011B7D4 File Offset: 0x0011A7D4
